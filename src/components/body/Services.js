                ...
                <div className="bgimg">
                    <div className="wrapper">
                        <div className="content">
                            <h1>SERVICES</h1>
                            <h2><span>WE ARE HERE</span> FOR YOU</h2>
                            <p>
                            ...
                            <Row>
                                <Col xs={12} sm={6} lg={3} className="col">
                                    <h3>WEB<br/>DESIGN</h3>
                                    <p>
                                    <span>Duis ipsum dolor sit amet incididunt ut labore et dolore magna.</span> <br/>
